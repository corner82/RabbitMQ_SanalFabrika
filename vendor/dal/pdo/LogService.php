 ...
 * @author Okan CIRAN
 */
class LogService extends \DAL\DalRabbitMQ {
   ...
   /**   
    ...
    public function insert($params = array()) {        
        try {
            ...
            $pk_temp = null;
            print_r($params);
            if(isset($params['pk_temp'])) $pk_temp = $params['pk_temp'] ;
            //if(isset($params['pk_temp'])) $pk_temp = $params['pk_temp'] ;
            ...
            $statement->bindValue(':pk_temp', $pk_temp, \PDO::PARAM_STR);
            ...
            $statement->bindValue(':params', $params['params'], \PDO::PARAM_STR) ;/*$params['params'], \PDO::PARAM_STR)*/
